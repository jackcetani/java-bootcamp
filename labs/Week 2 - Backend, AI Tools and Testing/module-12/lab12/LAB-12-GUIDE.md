...
1. Open [`lab12-crm/README.md`](lab12-crm/README.md).
2. Copy `lab12-crm/` into your `java-bootcamp/examples/lab12-crm/` target (see starter README).
...
1. **In class (timed path):** prefer [`lab12-crm/README.md`](lab12-crm/README.md) — copy starter → `java-bootcamp/examples/lab12-crm`, fill `// TODO`, run smoke test (~45 min).
