...
1. Open [`lab21-crm/README.md`](lab21-crm/README.md).
2. Copy `lab21-crm/` into your `java-bootcamp/examples/lab21-crm/` target (see starter README).
...
1. **In class (timed path):** prefer [`lab21-crm/README.md`](lab21-crm/README.md) — copy starter → `java-bootcamp/examples/lab21-crm`, fill `// TODO`, run smoke test (~45 min).
