...
1. Open [`lab14-crm/README.md`](lab14-crm/README.md).
2. Copy `lab14-crm/` into your `java-bootcamp/examples/lab14-crm/` target (see starter README).
...
1. **In class (timed path):** prefer [`lab14-crm/README.md`](lab14-crm/README.md) — copy starter → `java-bootcamp/examples/lab14-crm`, fill `// TODO`, run smoke test (~45 min).
