...
1. Open [`lab16-crm/README.md`](lab16-crm/README.md).
2. Copy `lab16-crm/` into your `java-bootcamp/examples/lab16-crm/` target (see starter README).
...
1. **In class (timed path):** prefer [`lab16-crm/README.md`](lab16-crm/README.md) — copy starter → `java-bootcamp/examples/lab16-crm`, fill `// TODO`, run smoke test (~45 min).
