...
1. Open [`lab20-crm/README.md`](lab20-crm/README.md).
2. Copy `lab20-crm/` into your `java-bootcamp/examples/lab20-crm/` target (see starter README).
...
1. **In class (timed path):** prefer [`lab20-crm/README.md`](lab20-crm/README.md) — copy starter → `java-bootcamp/examples/lab20-crm`, fill `// TODO`, run smoke test (~45 min).
