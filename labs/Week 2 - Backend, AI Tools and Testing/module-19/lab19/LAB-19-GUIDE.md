...
1. Open [`lab19-crm/README.md`](lab19-crm/README.md).
2. Copy `lab19-crm/` into your `java-bootcamp/examples/lab19-crm/` target (see starter README).
...
1. **In class (timed path):** prefer [`lab19-crm/README.md`](lab19-crm/README.md) — copy starter → `java-bootcamp/examples/lab19-crm`, fill `// TODO`, run smoke test (~45 min).
