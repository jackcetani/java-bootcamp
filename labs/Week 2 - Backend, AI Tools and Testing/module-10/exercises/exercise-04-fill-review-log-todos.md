...
**Module 10** · Hands-on exercise · [setup](EXERCISES-INDEX.md)

## Goal

Complete fill-in blanks for a Copilot review log before the timed lab.
...
A completed review-log TODO sheet with correct Northstar statuses.
