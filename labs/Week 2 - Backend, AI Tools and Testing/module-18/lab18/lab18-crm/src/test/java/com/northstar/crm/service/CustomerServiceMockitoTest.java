...
class CustomerServiceMockitoTest {
    ...
    void addCustomerCapturesSavedEntity() {
        ...
        service.addCustomer(Customer.amina()); // CUS-1001, Amina Khan, ACTIVE
    ...
    @Test
    void duplicateEmailNeverSaves() {
        // Manual equivalent of the optional Copilot Step 7 prompt — written by hand,
        // logged as "manual" in copilot-notes/ai-mockito-review.md.
        when(repository.existsById("CUS-1001")).thenReturn(false);
    ...
    @Test
    void illegalTransitionNeverSaves() {
        Customer amina = Customer.amina(); // ACTIVE
