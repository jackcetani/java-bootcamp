...
1. Open [`lab18-crm/README.md`](lab18-crm/README.md).
2. Copy `lab18-crm/` into your `java-bootcamp/examples/lab18-crm/` target (see starter README).
...
1. **In class (timed path):** prefer [`lab18-crm/README.md`](lab18-crm/README.md) — copy starter → `java-bootcamp/examples/lab18-crm`, fill `// TODO`, run smoke test (~45 min).
