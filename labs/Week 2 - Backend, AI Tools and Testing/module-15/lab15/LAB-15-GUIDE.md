...
1. Open [`lab15-crm/README.md`](lab15-crm/README.md).
2. Copy `lab15-crm/` into your `java-bootcamp/examples/lab15-crm/` target (see starter README).
...
1. **In class (timed path):** prefer [`lab15-crm/README.md`](lab15-crm/README.md) — copy starter → `java-bootcamp/examples/lab15-crm`, fill `// TODO`, run smoke test (~45 min).
