...
1. Open [`lab13-crm/README.md`](lab13-crm/README.md).
2. Copy `lab13-crm/` into your `java-bootcamp/examples/lab13-crm/` target (see starter README).
...
1. **In class (timed path):** prefer [`lab13-crm/README.md`](lab13-crm/README.md) — copy starter → `java-bootcamp/examples/lab13-crm`, fill `// TODO`, run smoke test (~45 min).
