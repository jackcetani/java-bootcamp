...
1. Open [`lab17-crm/README.md`](lab17-crm/README.md).
2. Copy `lab17-crm/` into your `java-bootcamp/examples/lab17-crm/` target (see starter README).
...
1. **In class (timed path):** prefer [`lab17-crm/README.md`](lab17-crm/README.md) — copy starter → `java-bootcamp/examples/lab17-crm`, fill `// TODO`, run smoke test (~45 min).
