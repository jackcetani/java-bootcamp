...
public class CustomerController {
  ...
  public CustomerEntity create(@RequestBody CreateCustomerRequest request) {
    return service.create(request.publicId(), request.fullName(), request.email(), request.status());
  }

  public record CreateCustomerRequest(String publicId, String fullName, String email, String status) {}
}