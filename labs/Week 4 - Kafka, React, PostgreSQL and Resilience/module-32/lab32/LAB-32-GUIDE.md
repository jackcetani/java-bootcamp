...
1. Open [`lab32-crm/README.md`](lab32-crm/README.md).
2. Copy `lab32-crm/` into your `java-bootcamp/examples/…` target (see starter README).
...
1. **In class (timed path):** prefer [`lab32-crm/README.md`](lab32-crm/README.md) — copy starter → `java-bootcamp/examples/lab32-crm`, fill TODOs, run smoke test (~45 min).
