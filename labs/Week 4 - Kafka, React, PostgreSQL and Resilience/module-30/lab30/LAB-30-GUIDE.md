...
1. Open [`lab30-crm/README.md`](lab30-crm/README.md).
2. Copy `lab30-crm/` into your `java-bootcamp/examples/…` target (see starter README).
...
1. **In class (timed path):** prefer [`lab30-crm/README.md`](lab30-crm/README.md) — copy starter → `java-bootcamp/examples/lab30-crm`, fill TODOs, run smoke test (~45 min).
