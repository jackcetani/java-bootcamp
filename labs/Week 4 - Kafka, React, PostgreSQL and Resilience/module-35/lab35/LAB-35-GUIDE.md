...
1. Open [`lab35-crm/README.md`](lab35-crm/README.md).
2. Copy `lab35-crm/` into your `java-bootcamp/examples/…` target (see starter README).
...
1. **In class (timed path):** prefer [`lab35-crm/README.md`](lab35-crm/README.md) — copy starter → `java-bootcamp/examples/lab35-crm`, fill TODOs, run smoke test (~45 min).
