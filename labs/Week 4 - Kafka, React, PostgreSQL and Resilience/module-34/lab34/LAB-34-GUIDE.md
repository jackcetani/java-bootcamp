...
1. Open [`lab34-crm/README.md`](lab34-crm/README.md).
2. Copy `lab34-crm/` into your `java-bootcamp/examples/…` target (see starter README).
...
1. **In class (timed path):** prefer [`lab34-crm/README.md`](lab34-crm/README.md) — copy starter → `java-bootcamp/examples/lab34-crm`, fill TODOs, run smoke test (~45 min).
