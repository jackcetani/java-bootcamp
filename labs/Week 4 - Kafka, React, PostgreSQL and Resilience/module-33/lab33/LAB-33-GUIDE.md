...
1. Open [`lab33-crm/README.md`](lab33-crm/README.md).
2. Copy `lab33-crm/` into your `java-bootcamp/examples/…` target (see starter README).
...
1. **In class (timed path):** prefer [`lab33-crm/README.md`](lab33-crm/README.md) — copy starter → `java-bootcamp/examples/lab33-crm`, fill TODOs, run smoke test (~45 min).
