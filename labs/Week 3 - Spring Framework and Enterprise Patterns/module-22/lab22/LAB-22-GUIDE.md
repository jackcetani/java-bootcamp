...
1. Open [`lab22-crm/README.md`](lab22-crm/README.md).
2. Copy `lab22-crm/` into your `java-bootcamp/examples/…` target (see starter README).
...
1. **In class (timed path):** prefer [`lab22-crm/README.md`](lab22-crm/README.md) — copy starter → `java-bootcamp/examples/lab22-crm`, fill `// TODO`, run smoke test (~45 min).
