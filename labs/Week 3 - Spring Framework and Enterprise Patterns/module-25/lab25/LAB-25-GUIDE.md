...
1. Open [`lab25-crm/README.md`](lab25-crm/README.md).
2. Copy `lab25-crm/` into your `java-bootcamp/examples/…` target (see starter README).
...
1. **In class (timed path):** prefer [`lab25-crm/README.md`](lab25-crm/README.md) — copy starter → `java-bootcamp/examples/lab25-crm`, fill `// TODO`, run smoke test (~45 min).
