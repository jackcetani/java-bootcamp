...
1. Open [`lab28-crm/README.md`](lab28-crm/README.md).
2. Copy `lab28-crm/` into your `java-bootcamp/examples/…` target (see starter README).
...
1. **In class (timed path):** prefer [`lab28-crm/README.md`](lab28-crm/README.md) — copy starter → `java-bootcamp/examples/lab28-crm`, fill `// TODO`, run smoke test (~45 min).
