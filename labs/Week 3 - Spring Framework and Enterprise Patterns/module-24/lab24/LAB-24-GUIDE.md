...
1. Open [`lab24-crm/README.md`](lab24-crm/README.md).
2. Copy `lab24-crm/` into your `java-bootcamp/examples/…` target (see starter README).
...
1. **In class (timed path):** prefer [`lab24-crm/README.md`](lab24-crm/README.md) — copy starter → `java-bootcamp/examples/lab24-crm`, fill `// TODO`, run smoke test (~45 min).
