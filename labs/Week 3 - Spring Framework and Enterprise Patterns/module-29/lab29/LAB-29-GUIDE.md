...
1. Open [`lab29-crm/README.md`](lab29-crm/README.md).
2. Copy `lab29-crm/` into your `java-bootcamp/examples/…` target (see starter README).
...
1. **In class (timed path):** prefer [`lab29-crm/README.md`](lab29-crm/README.md) — copy starter → `java-bootcamp/examples/lab29-crm`, fill `// TODO`, run smoke test (~45 min).
